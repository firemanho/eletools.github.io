...
function wasRechnen()
{
        if (document.getElementById("radiostromeingegeben").checked == true) {
                document.getElementById("elementinputstrom").style.display = "";
                document.getElementById("elementoutputleistung").style.display = "";
                document.getElementById("elementinputleistung").style.display = "none";
                document.getElementById("elementoutputstrom").style.display = "none";
        }        
        if (document.getElementById("radioleistungeingegeben").checked == true) {
                document.getElementById("elementinputstrom").style.display = "none";
                document.getElementById("elementoutputleistung").style.display = "none";
                document.getElementById("elementinputleistung").style.display = "";
                document.getElementById("elementoutputstrom").style.display = "";
        }        
}

function eingabe() // Liest die eingegebenen / Ausgewählten Werte ein und schreibt diese in Veriablen
{
	spannung = kommaZuPunkt(document.getElementById("inputspannung").value); // Spannung
	if (spannung < 0) {
        ...
        if (document.getElementById("radiostromeingegeben").checked == true) {
                strom = kommaZuPunkt(document.getElementById("inputstrom").value); // Strom
                if (strom < 0) {
                        alert(unescape("Der Wert darf nicht kleiner als 0 sein!"));
        ...
        if (document.getElementById("radioleistungeingegeben").checked == true) {
                leistung = kommaZuPunkt(document.getElementById("inputleistung").value); // Leistung
                if (leistung < 0) {
                        alert(unescape("Der Wert darf nicht kleiner als 0 sein!"));
                        document.getElementById("inputleistung").value = "0";
                        leistung = 0;
                }
        }
	absicherung = $('#Absicherung').val(); // Absicherung
	phi = kommaZuPunkt(document.getElementById("inputphi").value); // Phi
	if (phi > 1 || phi < 0) {
		alert(unescape("Phi darf nicht gr%F6%DFer als 1 oder kleiner als 0 sein!"));
		document.getElementById("inputphi").value = "0,9";
		phi = 0.9;
	}
	maxspannungsfall = kommaZuPunkt(document.getElementById("inputmaxspannungsfall").value); // Spannungsfall
	if (maxspannungsfall < 0) {
		alert(unescape("Der Wert darf nicht kleiner als 0 sein!"));
		document.getElementById("inputmaxspannungsfall").value = "3";
		maxspannungsfall = 3;
	}
	kabellaenge = kommaZuPunkt(document.getElementById("inputkabellaenge").value); // Kabellänge
	if (kabellaenge < 0) {
		alert(unescape("Der Wert darf nicht kleiner als 0 sein!"));
...
function rechneGleichStrom() {
        if (document.getElementById("radiostromeingegeben").checked == true) {
                leistung = round(spannung * strom, 2);
        }
        if (document.getElementById("radioleistungeingegeben").checked == true) {
                strom = round(leistung / spannung, 2);
        }
        spannungsfall = spannung / 100 * maxspannungsfall;
        querschnittspannungsfall = round(((2 * kabellaenge * strom) / (56 * spannungsfall)), 2);

}

function rechneWechselStrom() {
        if (document.getElementById("radiostromeingegeben").checked == true) {
                leistung = round(spannung * strom * phi, 2);
        }
        if (document.getElementById("radioleistungeingegeben").checked == true) {
                strom = round(leistung / spannung / phi, 2);
        }
	spannungsfall = spannung / 100 * maxspannungsfall;
	querschnittspannungsfall = round(((2 * kabellaenge * strom * phi) / (56 * spannungsfall)), 2);
}

function rechneDrehStrom() {
        if (document.getElementById("radiostromeingegeben").checked == true) {
                leistung = round(spannung * strom * phi * 1.73205081, 2);
        }
        if (document.getElementById("radioleistungeingegeben").checked == true) {
                strom = round(leistung / spannung / phi / 1.73205081, 2);
        }
	spannungsfall = spannung / 100 * maxspannungsfall;
	querschnittspannungsfall = round(((1.73205081 * kabellaenge * strom * phi) / (56 * spannungsfall)), 2);
}
...
{
        if (document.getElementById("radiostromeingegeben").checked == true) {
                document.getElementById("inputleistung").value = punktZuKomma(leistung);
        }
        if (document.getElementById("radioleistungeingegeben").checked == true) {
                document.getElementById("inputstrom").value = punktZuKomma(strom);
        }
	document.getElementById("outputstrom").firstChild.nodeValue = punktZuKomma(strom);
	document.getElementById("outputleistung").firstChild.nodeValue = punktZuKomma(leistung);
	document.getElementById("outputquerschnittspannungsfall").firstChild.nodeValue = punktZuKomma(querschnittspannungsfall) + " mm²";
